<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="img.aspx.cs" Inherits="Article.img" %>
...
<%--<head runat="server">--%>
    ...
    <body style="background: linear-gradient(rgba(253, 252, 252, 0.527),rgba(37, 6, 6, 0.5)), url(coffee4.jpg) no-repeat;background-size: cover">
   

        <br />
             
      <h1 class="loggo" style="margin-left:270px;">&nbsp;&nbsp;&nbsp; Upload your articles in form of Images&nbsp; </h1>
           <div class="pqr" style="margin-left:40%;">    
