<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="post.aspx.cs" Inherits="Article.post" %>
...
<div class ="info">
<%--<h1> Mountain</h1>--%>
<p>Add only Images of article..</p>
<button class="btn"><a href="img.aspx">Add Post</a></button>
</div>
</div>
<div  class="card"style="height:350px;">
<img src="blog3.jpg" />
<div class ="info" >
<%--<h1> Road</h1>--%>
<p >Add Images with discription of article..</p>
<button class="btn"><a href="imgtxt.aspx">Add Post</a></button>
...
<div class ="info" >
<%--<h1> Road</h1>--%>
<p >Add text messages of article..</p>
<button class="btn"><a href="text.aspx">Add Post</a></button>
